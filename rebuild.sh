...
sudo nixos-rebuild switch --show-trace --print-build-logs --flake ~/.dotfiles#${hostname} &>nixos-switch.log || (cat nixos-switch.log | grep --color error && exit 1)
