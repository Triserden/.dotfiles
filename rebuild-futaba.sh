...
sudo nixos-rebuild switch --build-host root@futaba --target-host root@futaba --flake .#futaba --log-format internal-json |& nom --json && nvd diff $(ls -dv /nix/var/nix/profiles/system-*-link | tail -2)
