# Once again shamelessly stolen from EmergentMind, thanks very much for the great config
...
{ config, lib, ... }:
{
  ...
  security.sudo.extraConfig = ''
    ...
    Defaults timestamp_timeout=30 # only ask for password every 30m
