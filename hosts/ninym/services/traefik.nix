...
in {
  ...
  virtualisation.oci-containers.containers."traefik" = {
    ...
    ports = [
      "100.103.59.112:80:80/tcp"
      "100.103.59.112:443:443/tcp"
      "8080:8080/tcp"
    ];
    cmd = [
      "--api=true"
    ...
    labels = {
      ...
      "traefik.http.routers.dashboard.rule" =
        "Host(`traefik.ninym.internal.triserden.dev`) && (PathPrefix(`/api`) || PathPrefix(`/dashboard`))";
  ...
  system.activationScripts.docker_networks = ''
    ${pkgs.docker}/bin/docker network inspect internal >/dev/null 2>&1 || \
