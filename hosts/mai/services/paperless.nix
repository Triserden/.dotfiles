...
in {
  ...
  virtualisation.oci-containers.containers."paperless-broker" = {
    ...
    volumes = [
      "/data/paperless/redisdata:/data:rw"
    ];
    log-driver = "journald";
    extraOptions = [
  ...
  virtualisation.oci-containers.containers."paperless-db" = {
    ...
    volumes = [
      "/data/paperless/pgdata:/var/lib/postgresql/data:rw"
    ];
    log-driver = "journald";
    extraOptions = [
      "--network-alias=db"
  ...
  virtualisation.oci-containers.containers."paperless-webserver" = {
    ...
    labels = {
      ...
      "traefik.http.routers.paperless.rule" = "Host(`paperless.local.triserden.dev`)";
